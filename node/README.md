...
3. The backend server is now running. You can access the example XtermJS page at `http://localhost:1337`.
...
4. **Start the Session** and then **Connect to the Terminal**
   ...
   - Once started, the Team IDs and User ID dropdowns will autofill. Select the team that you joined previously, there should only be one User ID.
