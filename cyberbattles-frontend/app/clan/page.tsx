...
const TagBackground = () => {
    ...
    useEffect(() => {
      ...
      // Gamer tags
      const tags = ["[Cyber]", "[Hack]", "[Binary]", "[Ghost]", "[Shadow]", "[Zero]", "[Glitch]", "[Matrix]", "[FazeBoost]"];
        ...
        <div className="flex h-screen pt-10 text-white">
          ...
          <main className="flex-1 flex flex-col items-center justify-center p-8">
            ...
            <header className="text-center mb-12">
              ...
              <h1 className="text-2xl font-bold mb-4">Join your friends, or create your own CyberBattles Clan!</h1>
            </header>
